...
class MaxPoolingLayer:
    ...
    def calculate(self, inp):
        ...
        for c in range(self.inputDim[2]):
            mLocChannel = []
            self.out.append((np.zeros((self.inputDim[0]-self.kernelSize+1, self.inputDim[1]-self.kernelSize+1))))
    ...
    def calculatewdeltas(self, wd):
        self.newwd = np.zeros((self.inputDim[2], self.inputDim[0], self.inputDim[1]))
        # print(self.newwd)
...
class FlattenLayer:
    ...
    def calculatewdeltas(self, wd):
        return np.reshape(wd, (self.inputDim[2], self.inputDim[0], self.inputDim[1]))
